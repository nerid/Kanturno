      ...
      <div className="relative z-10">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <div className="w-16 h-16 rounded-full bg-neon/20 flex items-center justify-center mb-6 border border-neon">
              <svg className="w-8 h-8 text-neon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
            </div>
            <h3 className="font-grotesk text-2xl uppercase mb-2 text-white">¡Afinando Garganta!</h3>
            <p className="font-mono text-sm text-cream/80 uppercase">
              Tu canción está en la cola. Revisa la lista abajo para ver tu turno.
            </p>
            <a href="#cola" className="mt-8 bg-white/10 hover:bg-white/20 text-white font-grotesk py-3 px-8 rounded-xl uppercase transition-colors">
              Ver la Cola
            </a>
          </div>
        ) : (
