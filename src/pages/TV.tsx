  ...
  return (
    <div className="w-full h-screen bg-[#010828] flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center items-center relative p-12">
        {/* Fondo animado sutil */}
        <div className="absolute inset-0 bg-gradient-to-br from-neon/10 to-blue-900/20 blur-3xl opacity-50 mix-blend-screen" />
        
        <div className="relative z-10 text-center flex flex-col items-center">
          <div className="flex items-center gap-4 text-neon mb-8">
          ...
          {cantando ? (
            <>
              ...
              <p className="font-condiment text-[40px] sm:text-[60px] lg:text-[80px] text-neon -rotate-2 mix-blend-plus-lighter" style={{ textTransform: 'none' }}>
                {cantando.cancion}
              </p>
            </>
          ) : (
